                ...
                <Row className='justify-content-center'>
                    <Col lg='6' xs='12' sm='12' md='8'>
                        <Form>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>First Button</Form.Label>
                                <Form.Control type="text" placeholder="first button" />
                            </Form.Group>
                            ...
                            <Form.Group className="mb-3" controlId="formBasicEmail">
                                <Form.Label>Second Button</Form.Label>
                                <Form.Control type="text" placeholder="second button" />
                            </Form.Group>
